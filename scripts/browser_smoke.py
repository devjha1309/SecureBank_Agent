...
def main():
    ...
    with sync_playwright() as p:
        ...
        page.get_by_text("Verification complete.", exact=False).wait_for(timeout=30000)
        ...
        browser.close()
    print(
        "Desktop/mobile browser flow passed: login, combined query, confirmed checkbook, hidden session cookie, cleared OTP, logout."
    )
